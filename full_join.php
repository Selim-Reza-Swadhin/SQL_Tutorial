<h2 align="center">SQL Full Join Two Tables matching All Data</h2>
<table bgcolor="#7fffd4" border="1" align="center" width="100%">
    ...
    $query = "SELECT  Persons.FirstName, Persons.LastName, Orders.Order_No
              ...
              FROM Persons /* left table name*/
              FULL OUTER JOIN Orders /* right table name*/
              ON
...
<!--SELECT  Persons.FirstName, Persons.LastName, Orders.Order_No
FROM Persons
FULL JOIN Orders
ON
